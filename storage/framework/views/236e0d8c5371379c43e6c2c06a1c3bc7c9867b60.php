        ...
        <table class="table table-sm border" id="studenttable">
            ...
            <tbody id="studenttbody">
                ...
                <tr>
                    ...
                    <?php if($d->active == 1): ?>
                    <td>Active</td> 
                <td><a class="btn btn-danger" href='teacherdisable/<?php echo e($d->user_id); ?>'>Disable</a></td>
                    <?php else: ?>
                    <td>Disabled</td> 
                <td><a class="btn btn-success" href='teacherenable/<?php echo e($d->user_id); ?>'>Enable</a></td>
                    <?php endif; ?>
                </tr>
