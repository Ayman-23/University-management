    ...
    <div id="flex-items">
        ...
        <div id="sidebar">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item all-links <?php echo e(Request::is('course') ? 'url_active' : ''); ?>" onclick="window.location='/course'"><span class="icons"><i class="fab fa-discourse" ></i></span><span>Course</span></li>
