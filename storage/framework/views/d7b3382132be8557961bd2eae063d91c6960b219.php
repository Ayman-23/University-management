...
<div class="container">
<h2>Welcome <span><i><h5><?php echo e($name[0]); ?></h5></i></span></h2>
    <div class="row-item">
        ...
        <div class="container flex-item">
            <div id="first" class="container text-white shadow p-3 mb-5">
                <h5>Advisor Of</h5>
            <h6><strong id="advisor_count"><?php echo e($advising_count); ?></strong> Section</h6>
            </div>
            <div id="second" class="container text-white shadow p-3 mb-5">
                <h5>Listed For </h5>
                <h6><strong id="subject_count"><?php echo e($subject_count); ?></strong> Subject/Subjects</h6>
            </div>
            <div id="third" class="container text-white shadow p-3 mb-5">
                <h5>Session</h5>
            <h6 id="session"><?php echo e($active_session->year.' '.$active_session->month); ?></h6>
            </div>
        </div>
    </div>
    <br>
